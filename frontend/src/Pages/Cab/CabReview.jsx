...
export default function CabReviewPage() {
  ...
  const addPassenger = () => {
    setPassengers([
      ...passengers,
      { id: passengers.length + 1, name: "", email: "", age: "" },
    ]);
  };
  ...
  return (
    <div className="min-h-screen flex justify-center items-center bg-black text-white font-[Poppins] p-6">
      <div className="w-full max-w-4xl bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl shadow-xl p-6">
        {/* Title */}
        <h1 className="text-4xl font-extrabold text-center mb-6 text-red-500 tracking-wide">
          Cab Review
        </h1>
        ...
        <div className="border border-[#222] bg-[#111] p-6 rounded-xl shadow-md mb-6">
          <h2 className="text-2xl font-semibold mb-4 text-red-400 flex items-center gap-2">
            <Car size={22} /> Cab Details
          </h2>
          <div className="grid grid-cols-2 gap-6 text-lg">
            {[
              ["Cab Name", "Sedan - XYZ123", Car],
              ["Driver", "John Doe", User],
              ["Pickup Location", "Connaught Place, New Delhi", Calendar],
              ["Drop-off Location", "Indira Gandhi International Airport", Calendar],
              ["Pickup Time", "8:00 AM", Clock],
              ["Estimated Drop-off Time", "8:45 AM", Clock],
              [
                "Status",
        ...
        {passengers.map((passenger, index) => (
          <div
            key={passenger.id}
            className="border border-[#222] bg-[#111] p-4 rounded-lg shadow-sm mb-4"
          >
