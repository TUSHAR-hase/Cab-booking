    ...
    return (
        <div className="min-h-screen bg-black text-white font-poppins relative overflow-hidden">
            ...
            <div className="relative h-[70vh] bg-black overflow-hidden">
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-b from-black/85 via-black/65 to-black/85"></div>
                </div>
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 max-w-5xl mx-auto">
                    ...
                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight animate-fade-in-up">
                        <span className="bg-gradient-to-r from-red-600 to-red-400 bg-clip-text text-transparent drop-shadow-2xl">
                            BookinHub
                        </span>
                    </h1>

                    {/* Subtitle */}
                    <p className="mt-6 text-xl md:text-3xl font-light text-gray-200 max-w-3xl mx-auto leading-relaxed animate-fade-in-down">
                        Discover a Universe of Seamless Adventures
                    </p>

                    {/* Button */}
                    <button className="mt-10 bg-red-600 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-xl hover:bg-red-700 hover:shadow-red-600/70 transition-all duration-500 transform hover:scale-105 flex items-center justify-center gap-3 group">
                    ...
                    <div className="mt-8 flex items-center justify-center gap-4 animate-fade-in animate-delay-300">
                        <div className="h-1 w-16 bg-red-600/60 rounded-full"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-28 relative z-10">
                ...
                <section className="flex flex-col items-center text-center">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 bg-gradient-to-r from-red-600 to-red-300 bg-clip-text text-transparent">
                        Our Mission
                    </h2>
                    <p className="text-lg md:text-xl text-gray-200 max-w-4xl leading-relaxed animate-fade-in">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div
                                key={index}
                                className="group bg-black/90 p-6 rounded-2xl border border-red-600/30 shadow-lg hover:shadow-red-600/60 hover:bg-red-600/20 transition-all duration-500 transform hover:-translate-y-2"
                            >
                                ...
                                <p className="text-gray-200 group-hover:text-white">{feature.desc}</p>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section className="flex flex-col items-center text-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-200 max-w-4xl leading-relaxed mb-8 animate-fade-in">
                    ...
                    <div className="relative bg-black/90 p-6 rounded-2xl border border-red-600/40 shadow-xl max-w-2xl transform hover:scale-105 transition-all duration-300">
                        <FaQuoteLeft className="absolute -top-4 -left-4 text-3xl text-red-600 animate-spin-slow" />
                        <p className="text-red-500 italic text-lg md:text-xl animate-glow">
            ...
            {/* Call to Action */}
            <div className="bg-black/95 py-16 text-center border-t border-red-600/40">
                <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 animate-pulse">
                    Ready to Elevate Your Booking Experience?
                </h3>
                <button className="bg-red-600 text-white px-10 py-4 rounded-full font-semibold text-lg shadow-xl hover:bg-red-700 hover:shadow-red-600/70 transition-all duration-500 transform hover:scale-110 flex items-center justify-center gap-2 mx-auto">
