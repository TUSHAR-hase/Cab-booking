...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white font-sans relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                {/* Gradient Orbs */}
                <div className="absolute -top-20 -left-20 w-96 h-96 rounded-full bg-red-600/10 blur-3xl"></div>
                <div className="absolute -bottom-40 -right-20 w-96 h-96 rounded-full bg-red-600/10 blur-3xl"></div>
            </div>
            ...
            >
                ...
                <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6 max-w-5xl mx-auto">
                    ...
                    >
                        <span className="bg-gradient-to-r from-red-600 via-red-500 to-red-400 bg-clip-text text-transparent drop-shadow-2xl">
                            Get in Touch
                        </span>
                    </motion.h1>
                    
                    <motion.p 
                        className="mt-6 text-xl md:text-2xl font-light text-gray-200 max-w-3xl mx-auto leading-relaxed"
                        initial={{ y: 50, opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
                    ...
                    >
                        ...
                        <a href="#find-us" className="inline-flex items-center gap-2 bg-transparent hover:bg-white/10 text-white border border-white/30 px-6 py-3 rounded-full font-semibold transition-all duration-300">
                ...
                <div className="absolute bottom-0 left-0 w-full overflow-hidden">
                    <svg 
                        ...
                        className="w-full h-20 text-gray-900 fill-current"
                    >
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-24 relative z-10">
                ...
                <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {contactMethods.map((method, index) => (
                        <motion.div 
                            key={index}
                            className="bg-gray-800/70 backdrop-blur-md p-8 rounded-2xl border border-gray-700 shadow-lg hover:shadow-red-600/10 group transition-all duration-300 hover:border-red-500/30 hover:-translate-y-1"
                            initial={{ opacity: 0, y: 30 }}
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.5, delay: 0.1 * index }}
                        >
                            <div className="w-14 h-14 rounded-full bg-red-600/10 flex items-center justify-center mb-4 group-hover:bg-red-600/20 transition-all duration-300">
                                <method.icon className="w-6 h-6 text-red-500" />
                            </div>
                            <h3 className="text-xl font-semibold text-white mb-2">{method.title}</h3>
                            <p className="text-gray-300 mb-4">{method.description}</p>
                            {method.items.map((item, i) => (
                                <div key={i} className="flex items-center gap-2 text-gray-200 mb-2 last:mb-0">
                                    {item}
                                </div>
                            ))}
                            {method.action && (
                                <a href={method.action.link} className="inline-flex items-center gap-1 text-red-400 hover:text-red-300 font-medium mt-4 group-hover:underline">
                ...
                <section id="contact-form" className="flex flex-col lg:flex-row gap-12 scroll-mt-16">
                    {/* Form */}
                    <motion.div 
                        className="flex-1 bg-gray-800/70 backdrop-blur-lg p-8 lg:p-10 rounded-2xl border border-gray-700 shadow-xl relative overflow-hidden"
                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 w-24 h-24 bg-red-600/10 rounded-full blur-3xl -ml-10 -mb-10"></div>
                        
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 bg-gradient-to-r from-red-600 to-red-300 bg-clip-text text-transparent">
                            Send Us a Message
                        </h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-4 rounded-lg bg-gray-900/70 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-red-500 transition-all duration-300"
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            {faqs.map((faq, index) => (
                                <div
                                    key={index}
                                    className="bg-gray-800/50 border border-gray-700 rounded-xl p-6 hover:border-red-500/30 transition-all duration-300 group"
                                >
                                    <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-red-400 transition-all duration-300">{faq.question}</h3>
                        ...
                        <div className="pt-6">
                            <a 
                                href="#" 
                                className="inline-flex items-center gap-2 bg-gray-800/70 hover:bg-gray-700/70 text-white px-6 py-3 rounded-full font-medium transition-all duration-300 border border-gray-700"
                            >
                ...
                <section id="find-us" className="scroll-mt-16">
                    <motion.div
                        ...
                        transition={{ duration: 0.7 }}
                    >
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4 bg-gradient-to-r from-red-600 to-red-300 bg-clip-text text-transparent">
                            Find Us
                        </h2>
                    ...
                    <motion.div 
                        className="w-full h-96 bg-gray-800/70 rounded-2xl border border-gray-700 shadow-lg overflow-hidden relative"
                        initial={{ opacity: 0, y: 30 }}
                        animate={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.7, delay: 0.2 }}
                    >
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            <div className="bg-gray-900/80 backdrop-blur-md p-6 rounded-xl border border-gray-700 max-w-md w-full">
                                <h3 className="text-xl font-semibold text-white mb-4">Our Headquarters</h3>
                                <p className="text-gray-300 mb-6">123 Travel Lane, Adventure City, CA 94103, USA</p>
                    ...
                    >
                        {offices.map((office, index) => (
                            <div 
                                key={index} 
                                className="bg-gray-800/40 p-6 rounded-xl border border-gray-700 hover:border-red-500/30 transition-all duration-300 hover:-translate-y-1"
                            >
                ...
                {/* CTA Section */}
                <motion.section 
                    className="bg-gradient-to-r from-red-900/20 via-red-600/20 to-red-900/20 rounded-3xl p-10 lg:p-16 text-center relative overflow-hidden border border-red-500/20"
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.7 }}
                >
                    ...
                    <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-10 relative z-10">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 relative z-10">
                        ...
                        <a 
                            href="#" 
                            className="bg-white/10 hover:bg-white/20 text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 backdrop-blur-sm"
                        >
                            View Destinations
                        </a>
                    </div>
